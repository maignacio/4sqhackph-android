...
public class HttpImageManager{
    ...
    private static HttpImageManager INSTANCE;
    private static final String BASEDIR = "/sdcard/httpimage";
    
    public static HttpImageManager getInstance() {
    	if(INSTANCE == null) {
    		INSTANCE = new HttpImageManager(HttpImageManager.createDefaultMemoryCache(), 
